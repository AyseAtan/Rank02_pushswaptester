...
echo " >> Shuffle 0 to 100000 with 42 ./checker"
./push_swap $(shuf -i 0-100000 -n 500) | ./test/checker_linux $(shuf -i 0-100000 -n 500)
...
echo " >> with invalid input: ./push_swap 0 one 2 3"
./push_swap 0 one 2 3
